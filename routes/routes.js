...
import {
  ...
  getDepartmentIdAdmin,getAllWithdrawalAdmin,
  updateDepartmentAdmin,AdminUpdateWallet,
...
router.post('/accept-Request', UserAcceptRequest);
...
router.post('/admin/order/timer', EmployeeTimerOrderController);

router.get('/admin/user/timer', GetUserTimerOrdersController);
...
function checkOrigin(req, res, next) {
  const allowedOrigins = [
    ...
    "http://localhost:3001",
    "https://localhost:80",
    "https://thehelply.com/", "https://admin.thehelply.com/",
...
router.put('/complete-order/:id', completeOrderUser);
...
router.put('/admin/update-user-meta/:id', updateUserLocationController);
...
router.post("/download-invoice-vendor", downloadVendorInvoice);
router.post("/download-invoice-order", downloadUserOrderInvoice);
router.post("/download-invoice-order-vendor", downloadVendorOrderInvoice);


router.post("/download-invoice-wallet", downloadWalletInvoice);


router.post("/admin/update-wallet", AdminUpdateWallet);
...
router.post("/order-payment", userOrderPayment);
